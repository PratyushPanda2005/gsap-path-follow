...
const content6 = {
  path02a_6: {
    title: "Reimagining High-Speed Rail in San Francisco",
    subtitle: "By Eleanor Stubbs — Updated for San Francisco (Map 6)",
  },
  path02b_6: {
    title: "Connecting Los Angeles with High-Speed Trains",
    subtitle: "By Curt Merrill — Updated for Los Angeles (Map 6)",
  },
  path02c_6: {
    title: "San Diego's High-Speed Future",
    subtitle: "By Alexandra Skores — Updated for San Diego (Map 6)",
  },
  path02d_6: {
    title: "High-Speed Vision for New York",
    subtitle: "By CNN Staff — Updated for New York (Map 6)",
  },
  path02e_6: {
    title: "Boston's Rail Revolution",
    subtitle: "By Alex Leeds Matthews — Updated for Boston (Map 6)",
  },
  path02f_6: {
    title: "Miami's High-Speed Transformation",
    subtitle: "By Agne Jurkenaite — Updated for Miami (Map 6)",
  },
  path02g_6: {
    title: "Seattle's High-Speed Connectivity",
    subtitle: "By Eleanor Stubbs — Updated for Seattle (Map 6)",
  },
};
...
const content7 = {
  path02a_7: {
    title: "Reimagining High-Speed Rail in San Francisco",
    subtitle: "By Eleanor Stubbs — Updated for San Francisco (Map 7)",
  },
  path02b_7: {
    title: "Connecting Los Angeles with High-Speed Trains",
    subtitle: "By Curt Merrill — Updated for Los Angeles (Map 7)",
  },
  path02c_7: {
    title: "San Diego's High-Speed Future",
    subtitle: "By Alexandra Skores — Updated for San Diego (Map 7)",
  },
  path02d_7: {
    title: "High-Speed Vision for New York",
    subtitle: "By CNN Staff — Updated for New York (Map 7)",
  },
  path02e_7: {
    title: "Boston's Rail Revolution",
    subtitle: "By Alex Leeds Matthews — Updated for Boston (Map 7)",
  },
  path02f_7: {
    title: "Miami's High-Speed Transformation",
    subtitle: "By Agne Jurkenaite — Updated for Miami (Map 7)",
  },
  path02g_7: {
    title: "Seattle's High-Speed Connectivity",
    subtitle: "By Eleanor Stubbs — Updated for Seattle (Map 7)",
  },
};
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function applyMap6Disables() {
    ...
    if (selectedMap1City) {
      (map6DisableRulesFromMap1[selectedMap1City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap2City) {
      (map6DisableRulesFromMap2[selectedMap2City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap3City) {
      (map6DisableRulesFromMap3[selectedMap3City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap4City) {
      (map6DisableRulesFromMap4[selectedMap4City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap5City) {
      (map6DisableRulesFromMap5[selectedMap5City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
  ...
  function applyMap7Disables() {
    ...
    if (selectedMap1City) {
      (map7DisableRulesFromMap1[selectedMap1City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap2City) {
      (map7DisableRulesFromMap2[selectedMap2City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap3City) {
      (map7DisableRulesFromMap3[selectedMap3City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap4City) {
      (map7DisableRulesFromMap4[selectedMap4City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap5City) {
      (map7DisableRulesFromMap5[selectedMap5City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
    if (selectedMap6City) {
      (map7DisableRulesFromMap6[selectedMap6City] || []).forEach((id) =>
        disabledSet.add(id)
      );
    }
  ...
  stops6.forEach((stop) => {
    stop.addEventListener("click", () => {
      ...
      tl6.fromTo(`#${pathId6}`, { drawSVG: "0%" }, { drawSVG: "100%" }, 0).to(
        "#point6",
        {
          autoAlpha: 1,
          motionPath: {
  ...
  stops7.forEach((stop) => {
    stop.addEventListener("click", () => {
      ...
      tl7.fromTo(`#${pathId7}`, { drawSVG: "0%" }, { drawSVG: "100%" }, 0).to(
        "#point7",
        {
          autoAlpha: 1,
          motionPath: {
